...
let reportUsageImpl = (_localRequestId: string, _usage: ProviderUsage): boolean => false;
...
function installNoopImplementations(): void {
	reportUsageImpl = (_localRequestId: string, _usage: ProviderUsage): boolean => false;
	reportProgressImpl = (
		_localRequestId: string,
		progress: Progress<LanguageModelResponsePart2>,
		part: LanguageModelResponsePart2
